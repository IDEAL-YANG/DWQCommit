...
@interface DWQCommitController ()<UITextViewDelegate,UIScrollViewDelegate>{
...
//    _explainLabel.text = @"添加图片不超过9张，文字备注不超过300字";
    ...
    [_submitBtn setTitle:@"评价" forState:UIControlStateNormal];
...
- (void)updateViewsFrame{
    ...
    //发布按钮
    _submitBtn.bounds = CGRectMake(10, _star.frame.origin.y+_star.frame.size.height +30, SCREENWIDTH -20, 40);
    _submitBtn.frame = CGRectMake(10, _star.frame.origin.y+_star.frame.size.height +30, SCREENWIDTH -20, 40);
...
- (void)submitToServer{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:nil message:@"评价成功!" preferredStyle:UIAlertControllerStyleAlert];
